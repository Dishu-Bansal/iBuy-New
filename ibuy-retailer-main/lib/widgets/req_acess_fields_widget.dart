...
class RequestAccessFieldsWidget extends StatelessWidget {
  const RequestAccessFieldsWidget({super.key});
            ...
            onTap: () {
              ...
              if (formKey.currentState!.validate()) {
                Get.to(AccountActivationPage(
                  ...
                  retailer: retailerController.dropDownValue!.value.toString(),
                ));
              } else {
